...
function setup() {
  ...
  PC= createSprite(windowWidth/2,windowHeight/2+200,10,10)
  PC.shapeColor = "red";
  ...
  reset = createSprite(windowWidth/2,windowHeight/2+200,10,10)
...
function draw() {
  ...
  if(gameState === 1){
    ...
    fill(0,0,255)
    textSize(100)
    text("you Lose",windowWidth/2-200,windowHeight/2)
